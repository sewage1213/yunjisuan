		...
		<td width="1500" height="700">
			<form name="ThisForm" method="POST" action="">
				<table width="410" height="198" border="0" align="right" cellpadding="0" cellspacing="0">
					<font face="楷体" size="20" color="red"> <jsp:getProperty name="loginname" property="userName"/>恭喜你，登录成功！</font>
<%--					<font face="楷体" size="20" color="red"> <jsp:getProperty name="loginname" property="adminName"/>恭喜你，成功了！！！</font>--%>
                </table>
	        </form>
        </td>
     </tr>
