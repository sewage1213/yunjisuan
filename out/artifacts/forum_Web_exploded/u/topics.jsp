					...
					<td
						...
						<div style="width: 400px;text-align: left;float: left;">
							<font style="font-size: 12px;color: #817E7E;">&nbsp;状态：</font> <font
								style="font-size: 14px;color: red;"> <s:if test="topic.niceTopic==1">[<font color="red">精品</font>]</s:if>
								<s:else></s:else> </font> <font style="font-size: 12px;color: #817E7E;">&nbsp;[评论量: <s:property
