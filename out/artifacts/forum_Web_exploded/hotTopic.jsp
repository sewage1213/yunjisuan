			...
			<div class="titleStyle" align="left">
				<table border="0" style="margin: 0;		font-size: 12px;">
					<tr style="height: 30px;line-height: 30px;">
						...
						<td style="width:50px" align="center">回复</td>
				...
				<table align="left" class="listTopicStyle">
					<s:iterator value="listTopic" id="topic">
						<tr>
							...
							test="#topic.niceTopic==1">[<font color="red">精品</font>]</s:if> <s:else></s:else></font><a
							...
							<td align="center" width="50px" style="font-size: 13px;"><s:property
									value="#topic.countComment" />
							</td>
							<td style="font-size: 12px;" width="120px;" align="right"><s:date
